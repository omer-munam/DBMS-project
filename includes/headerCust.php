                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="index.php" aria-expanded="false"><i class="fa fa-product-hunt"></i><span>Available Products</span></a>
                            </li>
                            <li>
                                <a href="Orders.php" aria-expanded="false"><i class="fa fa-dashboard"></i><span>My Orders</span></a>
                            </li>
                            <!-- <li>
